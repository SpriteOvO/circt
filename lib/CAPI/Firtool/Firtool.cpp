...
MlirLogicalResult firtoolPopulateLowerAnnotations(MlirPassManager pm) {
  return wrap(
      firtool::populateLowerAnnotations(*unwrap(pm), tempDefaultOptions));
}
...
MlirLogicalResult firtoolPopulatePrepareForExportVerilog(MlirPassManager pm) {
  return wrap(firtool::populatePrepareForExportVerilog(*unwrap(pm),
                                                       tempDefaultOptions));
}
