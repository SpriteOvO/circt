//===-- circt-c/Firtool.h - C API for Firtool-lib -----------------*- C -*-===//
//
//===----------------------------------------------------------------------===//

#ifndef CIRCT_C_FIRTOOL_H
#define CIRCT_C_FIRTOOL_H
...
firtoolPopulateLowerAnnotations(MlirPassManager pm);
...
MLIR_CAPI_EXPORTED MlirLogicalResult
firtoolPopulatePrepareForExportVerilog(MlirPassManager pm);
